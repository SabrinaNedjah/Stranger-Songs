<div class="category">
  <ul class="category_list_items">
    <li class="category_item">
      <a href="sequencer?type=1">
        <h4>80s</h4>
        <p>Create your soundtrack like Stranger Things's songs by living an old school experience by discovering our drumkit special 80s.</p>
      </a>
    </li>
    <li class="category_item">
